...
export default function WikiFXBrokers() {
  const [brokers, setBrokers] = useState([])

  useEffect(() => {
    setBrokers(getFromStorage(STORAGE_KEYS.WIKIFX_BROKERS, []))
  }, [])

  return (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900">WikiFX Broker</h2>
      </div>
